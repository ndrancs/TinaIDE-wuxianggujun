 ...
 */
abstract class CheckableNodeViewBinder<D>(itemView: View) : BaseNodeViewBinder<D>(itemView) {
     ...
     * @return
     */
    abstract fun getCheckableViewId(): Int
     ...
     * @param selected
     */
    open fun onNodeSelectedChanged(treeNode: TreeNode<D>, selected: Boolean) {
        /*empty*/
    }
}
